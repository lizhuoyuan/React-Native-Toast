        ...
        if (icon || icon === 0) {
            ...
            if (!React.isValidElement(icon)) {
                ...
                if (typeof icon === 'string') {
                    switch (icon) {
                        case 'success':
                            imageSource = require('IMG/icons/success.png');
                            break;
                        case 'fail':
                            imageSource = require('IMG/icons/fail.png');
                            break;
                        case 'smile':
                            imageSource = require('IMG/icons/smile.png');
                            break;
                        case 'sad':
                            imageSource = require('IMG/icons/sad.png');
                            break;
                        case 'info':
                            imageSource = require('IMG/icons/info.png');
                            break;
                        case 'stop':
                            imageSource = require('IMG/icons/stop.png');
                            break;
                        default:
                            imageSource = null;
                            break;
